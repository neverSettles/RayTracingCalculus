...
void draw(Direction userstartdirection, Point userstartpoint, vector <Shape*> listofshapes);
	...
	int main() 
	{
		...
		listofshapes.push_back(new Box(Point(-50, -50, 30), Direction(-10, 0, 0), Direction(0, 10, 0), Direction(0,0,10), RGB(255, 20, 60)));

		listofshapes.push_back(new Box(Point(-50, -10, -20), Direction(-10, 0, 0), Direction(0, 10, 0), Direction(0, 0, 10), RGB(255, 20, 60)));
		...
		listofshapes.push_back(new Capsule(Point(-2, -60,-15), Point(-225, 0,-15), 3, RGB(255, 0, 120)));//Pink Capsule Bottom
